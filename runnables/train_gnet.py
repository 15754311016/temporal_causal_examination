...
def main(args: DictConfig):
    ...
    # print("dataset_state_dict:", dir(dataset_collection))
    # dataset_state_dict = dataset_collection.state_dict()
    # print("dataset data_processed_seq:",dataset_collection.test_f_multi.data_processed_seq)
