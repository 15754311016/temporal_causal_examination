...
def generate_params(num_patients, chemo_coeff, radio_coeff, window_size, lag, binary_treatments):
    """
    ...
    basic_params['binary_treatments']=binary_treatments
    # basic_params['flag_reverse_t'] = flag_reverse_t
    return basic_params
